...
public class ValidationAspect {
	 ...
	 * logger.info("In Withdraw method"); Object args[] = pjp.getArgs();
	 * SavingsAccount account = (SavingsAccount) args[0]; Double amount = (Double)
	 * args[1];
	 * 
	 * if (account.getBankAccount().getAccountBalance() >= amount && amount > 0) {
	 * pjp.proceed(); logger.info("Withdraw Success"); } else {
